...
class PropertyClassesController extends Controller
{
    ...
    public function index(Panel $panel)
    {
        ...
        $propertyclasses = PropertyClasses::orderBy('display_order', 'asc')->get();
    ...
    {
        $propertyclasses            = new PropertyClasses();
    ...
    {
        $propertyclass = PropertyClasses::where('id', $id)->first();
    ...
    {
        $id                   = $request->input('id');
        $propertyclasses        = PropertyClasses::find($id);
