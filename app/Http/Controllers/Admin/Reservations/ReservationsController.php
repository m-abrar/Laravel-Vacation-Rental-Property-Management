...
class ReservationsController extends Controller
{
    ...
    public function index(Panel $panel)
    {
        ...
        $reservations_current = Reservations::where('date_start', '>=', date('Y-m-d'))->get();
        $reservations_history = Reservations::where('date_end', '<=', date('Y-m-d'))->get();
    ...
    public function updater(SelectDates $select_dates, ReservationsFormRequest $request, SendEmails $sendemails)
    {
        $id             = $request->input('id');
    ...
    public function save($request, $select_dates, $sendemails, $reservation, $date_start, $date_end)
    {
        ...
        if (!empty($reservation_id)) {
            ...
            $dates = Calendar::where('reservation_id', $reservation_id);
            $dates->delete();
