...
<link href="{{ asset('resources/plugins/jquery-awesomePOI/src/skins/skin2.css') }}" rel="stylesheet" type="text/css">
   ...
   <script>
      $( window ).load(function() {
        $('#apoi-maps-container').awesomePOI({
          start: "point",address: "Siddique Center Lahore",pyrmont: {lat: 31.531269, lng: 74.352699},radius: "1500",streetView: true,autocomplete: true,userLocation: true,routeMode: true,placesList: true,placeDetails: true,routeTime: true,route: true,multiple: true,iconSize: "large",iconColor: "gold",cluster: true,zoom: 15,wheelScroll: true,   });       
      });   
   </script> 
   @endsection
</div>
